...
window.cnblogsConfig = {
    menuCustomList: {
        "title1": { // 标题
            "data": [ // 列表数据 ['列表', '链接']
                ['我的博客1', 'https://www.cnblogs.com/IM-Fly'],
                ['我的博客2', 'https://www.cnblogs.com/IM-Fly'],
                ['我的博客3', 'https://www.cnblogs.com/IM-Fly'],
                ['我的博客4', 'https://www.cnblogs.com/IM-Fly'],
                ['我的博客5', 'https://www.cnblogs.com/IM-Fly'],
            ],
            "icon": "icon-brush_fill" // 配置图标，参考文档：定制化/字体图标库
        },
        "title2": { // 标题
            "data": [ // 列表数据 ['列表', '链接']
                ['我的博客6', 'https://www.cnblogs.com/IM-Fly'],
                ['我的博客7', 'https://www.cnblogs.com/IM-Fly'],
                ['我的博客8', 'https://www.cnblogs.com/IM-Fly'],
                ['我的博客9', 'https://www.cnblogs.com/IM-Fly'],
                ['我的博客10', 'https://www.cnblogs.com/IM-Fly'],
            ],
            "icon": "icon-brush_fill" // 配置图标，参考文档：定制化/字体图标库
        },
    },
...
window.cnblogsConfig = {
    menuNavList: [ // 列表数据 ['导航名称', '链接', 'icon']
        ['我的博客1', 'https://www.cnblogs.com/IM-Fly', 'icon-github'],
        ['我的博客2', 'https://www.cnblogs.com/IM-Fly', 'icon-github'],
    ],
}
```
