        ...
        9990: function (t, e, i) {
            ...
            !function () {
                ...
                var h = s.OrigamiValueConverter = {
                    ...
                    c = s.BouncyConversion = function (t, e) {
                ...
                t.extend(c.prototype, {
                    ...
                    fromOrigamiTensionAndFriction: function (t, e) {
                        return new o(h.tensionFromOrigamiValue(t), h.frictionFromOrigamiValue(e))
                        ...
                        return new o(0, h.frictionFromOrigamiValue(t))
                    }
                ...
                var _, u = s.MathUtil = {
                    mapValueInRange: function (t, e, i, s, n) {
                        ...
                        var o = Math.floor(t.mapValueInRange(e, n, r, i.r, s.r)),
                            ...
                            h = Math.floor(t.mapValueInRange(e, n, r, i.b, s.b));
                        return a ? "rgb(" + o + "," + l + "," + h + ")" : t.rgbToHex(o, l, h)
            ...
            var n = function () {
                ...
                r = function () {
                    ...
                    return n(t, [{
                        ...
                        key: "_getInscribedPoints", value: function (t, e) {
                            var i = this,
                                s = [];
                        ...
                        key: "_getInterpolatedPoint", value: function (t, e, i) {
                            var s = t.x,
                                n = t.y;
                        ...
                        key: "renderChildren", value: function (t, e) {
                            var i = this,
            ...
            var o = function () {
                function t(e) {
                    ...
                    var i = e.radius,
                        ...
                        h = e.restAt,
                        c = e.renderBase;
                    s < 3 && (console.warn("At least 3 sides required."), s = 3), this._canvas = document.createElement("canvas"), this._canvas.style.backgroundColor = o.background, this._canvas.style.zIndex = 1100, this._canvasW = null, this._canvasH = null, this._canvasOpacity = 1, this._centerX = null, this._centerY = null, this._alwaysForward = l, this._restThreshold = h, this._renderBase = c, this._springRangeLow = 0, this._springRangeHigh = this._restThreshold || 1, this._basePolygon = new r(i, s, n, o), this._progress = 0, this._isAutoSpin = null, this._isCompleting = null
                }
            ...
            function _() {
                let t, e = document.body,
                    ...
                    l = h()(o.querySelector("svg")).select("path"),
                    c = l.attr("d"),
                ...
                function u() {
                    ...
                    i = parseFloat(i.replace(/px/g, "")), r ? ($(e).removeClass("show-menu"), $("#content-wrap").fadeOut(300), $(e).css("overflow", "auto"), $("#mainContent").off("touchmove"), l.attr("d", c), _ = !1) : (a.add(e, "show-menu"), $("#content-wrap").show(), $("body").css("overflow", "hidden"), t.scrollTo(!1, "top")), r = !r
                }
            ...
            function g(t) {
                let e;
                $("#sidebar_news").prepend('<div class="container"> <div class="menu-wrap optiscroll" id="menuWrap" style="display:none"> <div class="close-button" id="close-button"> <i class="iconfont icon-close"></i> </div> <div class="sidebar-header"> <i class="iconfont icon-guangbo"></i> &nbsp;&nbsp; <span class="sidebar-title-msg"></span> </div> <div class="sidebar-profile"> <div class="user-pic" id="menuBlogAvatar"></div> <div class="sidebar-userinfo" id="introduce"></div> </div> <div class="sidebar-stats"></div> <div class="sidebar-search"> <div class="sidebar-search-div"> <div class="input-group"> <span id="sb-sidebarSearchBox"></span> <div class="input-group-append"> <span class="input-group-text"> <i class="iconfont icon-sousuo2"></i> </span> </div> </div> </div> </div> <div class="customize-nav"></div> <div id="calendar-box"></div> <div class="sidebar-menu" id="customize-sidebar-menu"> <ul></ul> </div> <div class="sidebar-menu"> <ul> <li class="ng-star-inserted sidebar-dropdown"> <a href="javascript:void(0)" class="ng-star-inserted sidebar-dropdown-box"> <i class="iconfont icon-collection_fill"></i> <span class="sidebar-dropdown-title">积分排名</span> </a> <div class="sidebar-submenu" id="sb-sidebarScorerank"></div> </li> <li class="ng-star-inserted sidebar-dropdown"> <a href="javascript:void(0)" class="ng-star-inserted sidebar-dropdown-box"> <i class="iconfont icon-time_fill"></i> <span class="sidebar-dropdown-title">最新随笔</span> </a> <div class="sidebar-submenu" id="sb-sidebarRecentposts"></div> </li> <li class="ng-star-inserted sidebar-dropdown"> <a href="javascript:void(0)" class="ng-star-inserted sidebar-dropdown-box"> <i class="iconfont icon-label_fill"></i> <span class="sidebar-dropdown-title">我的标签</span> </a> <div class="sidebar-submenu" id="sb-toptags"></div> </li> <li class="ng-star-inserted sidebar-dropdown"> <a href="javascript:void(0)" class="ng-star-inserted sidebar-dropdown-box"> <i class="iconfont icon-fenleicur"></i> <span class="sidebar-dropdown-title">随笔分类</span> </a> <div class="sidebar-submenu" id="sb-classify"></div> </li> <li class="ng-star-inserted sidebar-dropdown"> <a href="javascript:void(0)" class="ng-star-inserted sidebar-dropdown-box"> <i class="iconfont icon-fenlei"></i> <span class="sidebar-dropdown-title">文章分类</span> </a> <div class="sidebar-submenu" id="sb-ArticleCategory"></div> </li> <li class="ng-star-inserted sidebar-dropdown"> <a href="javascript:void(0)" class="ng-star-inserted sidebar-dropdown-box"> <i class="iconfont icon-browse_fill"></i> <span class="sidebar-dropdown-title">阅读排行</span> </a> <div class="sidebar-submenu" id="sb-topview"></div> </li> <li class="ng-star-inserted sidebar-dropdown"> <a href="javascript:void(0)" class="ng-star-inserted sidebar-dropdown-box"> <i class="iconfont icon-like_fill"></i> <span class="sidebar-dropdown-title">推荐排行</span> </a> <div class="sidebar-submenu" id="sb-topDiggPosts"></div> </li> <li class="ng-star-inserted sidebar-dropdown"> <a href="javascript:void(0)" class="ng-star-inserted sidebar-dropdown-box"> <i class="iconfont icon-pinglunzu"></i> <span class="sidebar-dropdown-title">最新评论</span> </a> <div class="sidebar-submenu" id="sb-recentComments"></div> </li> <li class="ng-star-inserted sidebar-dropdown"> <a href="javascript:void(0)" class="ng-star-inserted sidebar-dropdown-box"> <i class="iconfont icon-task_fill"></i> <span class="sidebar-dropdown-title">随笔档案</span> </a> <div class="sidebar-submenu" id="sb-record"></div> </li> <li class="ng-star-inserted sidebar-dropdown"> <a href="javascript:void(0)" class="ng-star-inserted sidebar-dropdown-box"> <i class="iconfont icon-document_fill"></i> <span class="sidebar-dropdown-title">文章档案</span> </a> <div class="sidebar-submenu" id="sb-articlearchive"></div> </li> </ul> </div> <div class="sidebar-footer"></div> <div class="morph-shape" id="morph-shape" style="display:none" data-morph-open="M-7.312,0H15c0,0,66,113.339,66,399.5C81,664.006,15,800,15,800H-7.312V0z;M-7.312,0H100c0,0,0,113.839,0,400c0,264.506,0,400,0,400H-7.312V0z"> <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 100 800" preserveAspectRatio="none"> <path d="M-7.312,0H0c0,0,0,113.839,0,400c0,264.506,0,400,0,400h-7.312V0z"/> </svg> </div> </div> <button class="menu-button" id="open-button">MENU</button> <div class="content-wrap" id="content-wrap"></div> </div>'), e = _(), (() => {
                    let e = t.__tools.tempReplacement('<div class="dropdown"> <a href="https://www.cnblogs.com/##user##" target="_self"> <i class="iconfont icon-homepage_fill"></i>首页 </a> </div> <div class="dropdown"> <a href="https://msg.cnblogs.com/send/##user##" target="_blank"> <i class="iconfont icon-zhifeiji"></i>联系 </a> </div> <div class="dropdown"> <a href="javascript:void(0)" onclick=\'$("#blog_nav_rss").trigger("click")\' data-rss="https://www.cnblogs.com/##user##/rss/"> <i class="iconfont icon-qinmifu"></i>订阅 </a> </div> <div class="dropdown"> <a href="https://i.cnblogs.com/posts/edit/" target="_blank"> <i class="iconfont icon-setup_fill"></i>管理 </a> </div>', "user", t.__status.user);
                    ...
                    t.__timeIds.introduceTId = window.setInterval((() => {
                    ...
                    }), e), t.__timeIds.blogStatsTId = window.setInterval((() => {
                        let e = $(".blogStats"),
                            i = $("#stats_post_count"),
                            s = $(".sidebar-stats");
                        e.length > 0 && i.length > 0 && (s.html(t.__tools.htmlFiltrationScript(e.html())).show(), e.html(""), t.__tools.clearIntervalTimeId(t.__timeIds.blogStatsTId))
                        ...
                        e.length > 0 && "" === i.html() && (i.prepend('<div id="sb_widget_my_zzk" class="div_my_zzk"><input id="q" type="text"  autocomplete="off" placeholder="找找看..." onkeydown="return zzk_go_enter(event);" class="input_my_zzk form-control search-menu"></div>'), $(".sidebar-search").show(), t.__tools.clearIntervalTimeId(t.__timeIds.searchTId))
                        ...
                        e.length > 0 && "" === i.html() && (i.html((t => {
                            ...
                            if (t.find("li").length > 2) {
                                ...
                                e.each((t => {
                                    ...
                                    let h = $.trim(l.join("."));
                                    o.length > 0 && o.html(h), n += "<li>" + (o.length > 0 ? o.prop("outerHTML") : "<a href='javascript:void(0);'>" + h + "</a>") + '<div class="sb-recent_comment_body">' + $(i[t]).text() + '</div><div class="sb-recent_comment_author">' + $(s[t]).text() + "</div></li>"
                                }))
                            }
                            return n += "</ul>", n
